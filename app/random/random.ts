...
@template(Random)
export class random {
	onBeforeMount(this: RiotComponent<RandomComponentProps,RandomComponentState>) {
		this.state = {
			number: null,
			logs: []
		}
    ...
    generate(this: RiotComponent<RandomComponentProps,RandomComponentState>, event: MouseEvent) {
        this.update({
